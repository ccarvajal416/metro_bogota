...
lyr_Cuenca_Alta_Rio_Bogota_4.set('fieldLabels', {'qc_id': 'no label', 'objectid': 'no label', 'area_ha': 'no label', 'tipo': 'no label', 'nombre': 'no label', 'acto_admin': 'no label', 'orig_fid': 'no label', 'categoria': 'no label', 'shape_leng': 'no label', 'shape_area': 'no label', });
